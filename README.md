...
- Run the magic incantation: `cluster -s CVM_IP --redundancy_factor=1 create` In an production setup you would not be using FTT 0! (where CVM_IP is your CVM's IP. Mine's 10.10.0.5. Yours isn't. Use yours. Pattern recognition isn't rocket science.)
